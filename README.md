...
jetbrains-kotlin-android = { id = "org.jetbrains.kotlin.android", version.ref = "kotlin" }
        ...
        <p style="text-color:#fff">
            You can view the full <code>libs.versions.toml</code> file <a href="https://github.com/fekri8614/android-worker/blob/master/gradle/libs.versions.toml" target="_blank">here</a>.
        </p>
    </section>
